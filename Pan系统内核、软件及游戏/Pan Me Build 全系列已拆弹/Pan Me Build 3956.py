...
def kfz():
    ...
    while 1:
        ...
        print("\033[95m1.命令提示符    \033[93m2.计算机      \033[92m3.记事本     \033[90m4.关机     ")
...
try:
    ...
    qing()
    while 1:
        print("\033[90mPan公测版本\n评估副本。过期时间2021/8/23。\033[0m")
