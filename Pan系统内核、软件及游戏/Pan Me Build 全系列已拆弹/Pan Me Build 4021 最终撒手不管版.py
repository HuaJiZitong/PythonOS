...
try:
    ...
    if panme=="3":
        ...
        while 1:
            ...
            print("\033[94m7.Reinstall system")
                    ...
                    if prog=="A":
                        ...
                        if llqjh==1:
                            if prog=="C":
                                ...
                                b("\033[90mChoise a Color(Disabled):A.Highest(8 bit) B.Black(2 bit) C.256 colors")
                            elif prog=="D":
                                b(ctime())
    ...
    if panme=="2":
        ...
        while 1:
            if classic==0 or classic==2:
                ...
                print("\033[95m7.浏览器        \033[34m8.计算机      \033[35m9.Pan系统入门 ")
            ...
            if prog=="0":
                ...
                if rm=="1":
                    ...
                    b("1)在浏览器运行过程中蓝屏了怎么办?\n点击下面的改编按钮，找到【浏览器】的脚本，更改一下出错源码位置，或者重新按运行键\n")
        ...
        ''')
        print("\033[90m  HOTM")
        print("\033[91m   Pan® Me Ultimate Edition")
        print("\n\033[94m           Starting up...\n",end="")
        print("\033[44m"+40*" ")
        sleep(3)
        print("\033[0m")
        ...
        while 1:
            if classic==0 or classic==2:
                ...
                print("\033[95m9.浏览器        \033[34m10.计算机      \033[35m11.Pan系统入门 ")
                prog=input("\033[0m请输入应用序号:")
            else:
                print("\033[103m")
                qing()
            ...
            if prog=="0":
                ...
                print("\033[0mHOTM Pan[版本5.11.4021]")
                ...
                if rm=="1":
                    ...
                    b("1)在浏览器运行过程中蓝屏了怎么办?\n点击下方改编按钮，找到【浏览器】的脚本，更改一下出错源码位置，或者重新按运行键\n")
                    b("2)总是提醒该词条不存在是怎么肥事?\n检查拼写是否正确或者输入\"帮助\"看看浏览器里面都有什么词条。\n")
                    b("3)超长了怎么办?\n重按运行键即可。\n4)为什么浏览器退不出来?\n等浏览器返回到主页，输入\"退出\"即可。")
                elif rm=="4":
                    b("如果您的电脑运行的是已经停止支持的Pan2.0或者是即将停止支持的Pan3.0，我们建议您升级到Pan2020及以上版本，谢谢配合！")
